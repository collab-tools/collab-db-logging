  ...
  return sequelize.define('file_log', {
    ...
    classMethods: {
      ...
      getFiles: function getFiles(email, projectId) {
        var start = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : (0, _moment2.default)(0).toDate();
        var end = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : (0, _moment2.default)().toDate();
